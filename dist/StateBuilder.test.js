...
import { ANCHOR, MODEL, } from './StateBuilder.mock';
const header = (instanceType, id, operation = 'create') => {
    return {
        id: id,
...
describe('StateBuilder', () => {
    let stateBuilder;
    beforeEach(() => {
        stateBuilder = new StateBuilder(MODEL, ANCHOR, false);
    });
    ...
    it('creates state with anchor data when it is received', () => {
        const instance = { projectName: 'Project #1', ...header('ProjectSerializer', 1) };
